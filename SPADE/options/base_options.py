...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--label_nc', type=int, default=255, help='# of input label classes without unknown class. If you have unknown class as class label, specify --contain_dopntcare_label.')
        parser.add_argument('--contain_dontcare_label',default=True, help='if the label map contains dontcare label (dontcare=255)')
